...
const translations = {
  zh: {
    ...
    'demo.labDesc': '以下列表为该 API 分发的全套预设主题（共 147 种）。点击卡片即可全站实时换肤（包括背景、文字、粒子甚至自定义 CSS 特效）。',
  ...
  en: {
    ...
    'demo.labDesc': 'The complete preset catalog distributed by this API (147 total). Click any card to live-switch the entire site theme (background, text, particles, even custom CSS effects).',
